      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 max-w-xs">{settings.siteDescription}</p>
                <div className="flex space-x-4">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-900 dark:text-white mb-4">
              {settings.footer?.quickLinks || "Түсламж"}
            </h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-sm text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary"
                >
                  {settings.navigation?.about || "Бидний тухай"}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-900 dark:text-white mb-4">
              {settings.footer?.resources || "Нэмэлт"}
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-900 dark:text-white mb-4">
              {settings.footer?.contactUs || "Холбоо барих"}
            </h3>
            {loading ? (
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">{settings.contactInfo.address}</span>
                </li>
                <li className="flex items-center">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-sm text-center text-gray-500 dark:text-gray-400">
            ...
            {settings.footer?.allRightsReserved || "Бүх эрх хуулиар хамгаалагдсан."}
          </p>
        </div>
      </div>
    </footer>
